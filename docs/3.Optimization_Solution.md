...
These optimizers produce optimal instructions for the prompt and, in the case of MIPROv2 can also optimize the set of few-shot demonstrations.
    ...
    - open the saved checkpoint file to understand what is the system instruction that is generated automatically for us. it also has the examples that are used.